...
try:
  ...
  out = cv2.VideoWriter('output15_1self.avi',fourcc, 90.0, (1280, 960))
  ...
  ######################## Import Trained Driving Model for Self Driving ###############
  ...
  file_name = 'training_data_keys_v15_1self.npy'
...
##                  if str_label == pygame.K_w:
##                    forward = False
##                    key_flag=0
##                  elif str_label == pygame.K_a:
##                    left = False
##                    key_flag=0
##                  elif str_label == pygame.K_s:
##                    reverse = False
##                    key_flag=0
##                  elif str_label == pygame.K_d:
##                    right = False
##                    key_flag=0
##                  elif str_label == pygame.K_e:
##                    home = False
##                    key_flag=0
##                    
